...
const FreeVideo = () => {
  ...
  const { videos, totalVideoCount } = useSelector((state) => state.free_video);
  ...
  useEffect(() => {
    dispatch(setCurrentPage({ currentPage: "Free Videos" }));
  }, []);
  ...
  }, [language, query, curPage, resultPerPage]);
    ...
    if (
      ...
      try {
        ...
        const { data } = await axios.delete(
          `/api/free-video/delete-video/${id}`,
          {
            headers: {
                        ...
                        <td>
                          <div className="action-link">
                            <Link
                              ...
                              to={`/admin/edit-free-video/${data._id}`}
